...
/*! jquery.slimscroll.js Version: 1.3.8 */
...
$(function () {
    ...
    //switch
    $('[class="form-input-switch"]').bootstrapSwitch({
        onText: "是",
        offText: "否",
        onColor: "success",
        offColor: "danger",
        ...
        onSwitchChange: function (event, state) {
            ...
            $('#'+$input).val(state ? '1' : '0').change();
        }
    });

    //数字输入
    $('.form-input-number:not(.initialized)')
...
$(function () {
     ...
     * 单按钮ajax操作
     * layerConfirm 确认框
     * layerType layer方式，1为ajax请求，2为弹出页面
     * layerMethod 请求方式
     */
    $(".AjaxButton").on('click', function(){
        ...
        /*需要确认操作*/
        if(layerConfirm==1){
            var layerTitle = $(this).data("title") || '操作确认';
            var layerMsg = $(this).data("msg") || '您确定要执行此操作吗?';
            layer.confirm(layerMsg,{title:layerTitle,closeBtn:1,icon:3},function(){
                if(layerType==1){
